                        ...
                        <div v-for="(item, index) in slotProps.items" :key="index">
                            <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4" :class="{ 'border-t border-surface': index !== 0 }">
                                <div class="md:w-40 relative">
                                    <Image class="block xl:block mx-auto rounded w-full" :src="`https://primefaces.org/cdn/primevue/images/product/${item.image}`" :alt="item.name"/>
                                ...
                                <div class="flex flex-col md:flex-row justify-between md:items-center flex-1 gap-6">
                                    ...
                                    <div class="flex flex-col md:items-end gap-8">
                                        ...
                                        <div class="flex flex-row-reverse md:flex-row gap-2">
                                            ...
                                            <Button icon="pi pi-download" @click="visibleBottom = true"  label="Download" :disabled="item.inventoryStatus === 'OUTOFSTOCK'" class="flex-auto md:flex-initial whitespace-nowrap" ></Button>
                                            <Button icon="pi pi-shopping-cart" label="Beli" :disabled="item.inventoryStatus === 'OUTOFSTOCK'" class="flex-auto md:flex-initial whitespace-nowrap"></Button>
                                        </div>
                                    </div>
                                </div>
